                    ...
                    <div class="parameter">
                     ...
                     <!-- 供应商jieshu --> 
                      <p class="providerp">
                        ...
                        <div class="servicecontain" v-html="detailproviderProduct.serviceContent"></div>
                     <p class="providerp">
                             用户评价
                          </p>
                          <div class="pingjia">
    ...
    created(){
        ...
        //登录判断
           that.ajax.post(
                    ...
                    that.loginstate=data.data.status;
            })
        // over
        that.ajax.post(
